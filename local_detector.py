...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--input_path", required=True, help="the model input") #--input_path examples/modified.jpg
    parser.add_argument(
        "--dest_folder", required=True, help="folder to store the results")#--dest_folder out/
    parser.add_argument(
        "--model_path", required=True, help="path to the drn model")#--model_path weights/local.pth
    parser.add_argument(
